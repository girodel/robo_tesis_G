...
# ================== ENVIRONMENT SETUP =================== #
    ...
    rviz_config_file_name = 'nav_2.rviz'
...
# ================= GAZEBO BRIDGES & SENSOR SETUP =================== #
    ...
    ros_gz_bridge = Node(
        ...
        arguments=[
            ...
            # 🔥 EL PUENTE PARA LA LUZ TRASERA ESTÁ AQUÍ 🔥
            '/world/area_emergencia/light_config@ros_gz_interfaces/msg/Light]ignition.msgs.Light'
        ],
