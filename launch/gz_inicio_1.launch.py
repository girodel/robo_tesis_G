...
# ================== ENVIRONMENT SETUP =================== #
    ...
    rviz_config_file_name = 'my_robo.rviz'###pones el rviz que creaste
    
    # 🔥 El archivo del mundo personalizado ya no es necesario para el mundo vacío
...
# ============== GAZEBO - SETUP AND LAUNCH ================ #
    ...
    # 🔥 Le indicamos a Gazebo que cargue el mundo vacío por defecto
    gz_args_value = ['-r empty.sdf']
